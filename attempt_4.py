...
Attempt 4 notes:
- Builds on attempt 2's custom masked attention and local/global head schedule.
- Always retains at least one local-context head in every layer.
- Randomizes which head indices are local versus global per layer, deterministically from the run seed.
"""
